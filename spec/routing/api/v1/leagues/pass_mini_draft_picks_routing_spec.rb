...
RSpec.describe Api::V1::Leagues::PassMiniDraftPicksController, type: :routing do
  describe "routing" do
    ...
    it "routes to #create" do
      expect(:post => base_route).to route_to({
        controller: "api/v1/leagues/pass_mini_draft_picks",
        action: "create",
        league_id: "1",
      })
    end
  ...
  def base_route
    "/api/v1/leagues/1/pass_mini_draft_picks"
  end
end
